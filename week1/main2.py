...
def gradient_descent_runner(graf, points, starting_b, starting_m, learning_rate, step_volume):
    '''points2 = []
    for point in points:
        point = point * 2000 # need to remove decimals because they mess up algo
